...
export default function AboutPage() {
  ...
  return (
    <div>
      ...
      />
      <Container sx={{ textAlign: "left", marginTop: 4 }}>
        <Paper elevation={3} sx={{ padding: 4, marginBottom: 4 }}>
          ...
          <Typography paragraph>
            ...
            <br />
            A: Once registered as a business user, navigate to the 'Cards' , 'MY
            Cards' or 'Favorite Cards' pages, click on the + and fill in the
            necessary details.
            <br />
        ...
        <Paper elevation={3} sx={{ padding: 4 }}>
          ...
          <Typography paragraph>
            Email: <strong>nikita.fbein@gmail.com</strong>
            <br />
            Phone: <strong>052-6466513</strong>
          </Typography>
